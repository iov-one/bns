...
lint:
	@go mod vendor
	docker run --rm -it -v $(shell pwd):/go/src/github.com/iov-one/bns -w="/go/src/github.com/iov-one/bns" golangci/golangci-lint:v1.17.1 golangci-lint run ./...
	@rm -rf vendor
...
cover:
	...
	# TODO uncomment when bnsd/bnscli imported
